...
| 维度 | 已完成 | 待完成 | 进度 |
|------|--------|--------|------|
| 📖 教程阅读 | Ch1-Ch4 + Ch6 + Ch9-Ch11 + Ch13 + Dify/Coze文档（Ch5半完成） | Ch5补完 + Ch7-8/12/14-16 | 11/16 |
| 💻 代码学习 | Day1 核心代码 | day01补充 + day02代码 + supplement末尾对比表 | 6/9 |
| 📝 LeetCode | 18题 | 39题 | 18/57 |
| 📖 八股背诵 | 第1章(5题) + 第2章(5题)已背 + 第5章(9题)已过未熟 | 第2章Q2-5补背 + 第3-4/6-15章 | 19/75 |
...
| # | 章节 | 路径 | 阅读程度 |
|---|------|------|----------|
| 1 | LangChain概述与架构 | `ai-agents-from-zero/9-LangChain概述与架构.md` | ✅ 已看完 |

### 📝 LeetCode（1题）

| # | 题号 | 题目 | 难度 | 考点 | 状态 |
|---|------|------|------|------|------|
| 1 | 206 | 反转链表 | 简单 | 链表/递归 | ✅ 完成 |

### 📖 八股（第2章 6题，背了5题）

| # | 内容 | 来源 | 状态 |
|---|------|------|------|
| Q2-1 | System Message 和 User Message 怎么分工？ | 题库 Q2-1 | ✅ 已背诵 |
| Q2-2 | 结构化输出有哪些做法？各自优缺点？ | 题库 Q2-2 | ✅ 已背诵 |
| Q2-3 | Prompt Injection 是什么？RAG/Agent 为什么要小心？ | 题库 Q2-3 | ✅ 已背诵 |
| Q2-4 | 如何系统优化提示词并把准确率做上去？ | 题库 Q2-4 | ✅ 已背诵 |
| Q2-5 | Prompt 工程的边界是什么？ | 题库 Q2-5 | ❌ 未背 |
| Q2-6 | 如何做 Prompt 版本管理与回归？ | 题库 Q2-6 | ✅ 已背诵 |
...
| # | 章节 | 路径 | 阅读程度 |
|---|------|------|----------|
| 1 | LangChain快速上手与HelloWorld | `ai-agents-from-zero/10-LangChain快速上手与HelloWorld.md` | ✅ 文档已看完，案例源码未看 |
| 2 | Model-I-O与模型接入 | `ai-agents-from-zero/11-Model-I-O与模型接入.md` | ✅ 已看完 |
| 3 | 提示词与消息模板 | `ai-agents-from-zero/13-提示词与消息模板.md` | ✅ 已看完 |

### 📝 LeetCode（2题）

| # | 题号 | 题目 | 难度 | 考点 | 状态 |
|---|------|------|------|------|------|
| 1 | 207 | 课程表 | 中等 | 拓扑排序 | ✅ 完成 |
| 2 | 208 | 实现 Trie (前缀树) | 中等 | 前缀树 | ✅ 完成 |

---

## 📊 累计统计

- **LeetCode 四刷完成：61/100 题**（此前已完成 43 题 + Day1 4题 + Day2 4题 + Day3 0题 + Day4 7题 + Day5 1题 + Day6 2题）
- **八股背诵：19/75 题**（第1章5题 + 第2章5题已背 + 第5章9题已过未熟）
